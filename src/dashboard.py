...
class DashboardService:
    ...
    def get_dashboard_metrics(self) -> List[DashboardMetric]:
        ...
        metrics.append(DashboardMetric(
            ...
            unit="%",
            trend="down" if error_rate < 0.01 else "up" if error_rate > 0.05 else "stable",
        ...
        metrics.append(DashboardMetric(
            ...
            value=hit_ratio * 100,
            unit="%",
            trend="up" if hit_ratio > 0.8 else "down" if hit_ratio < 0.6 else "stable",
            status="good" if hit_ratio > 0.8 else "warning" if hit_ratio > 0.6 else "critical",
        ...
        metrics.append(DashboardMetric(
            ...
            status="good" if memory_usage < 500 * 1024 * 1024 else "warning" if memory_usage < 1024 * 1024 * 1024 else "critical",
        ...
        metrics.append(DashboardMetric(
            ...
            status="good" if active_connections < 100 else "warning" if active_connections < 500 else "critical",
