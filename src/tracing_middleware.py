...
class DatabaseTracingMiddleware:
    ...
    @staticmethod
    def trace_database_performance(
...
class CacheTracingMiddleware:
    ...
    @staticmethod
    def trace_cache_performance(
        operation: str, duration_ms: float, hit: bool = None, **kwargs
    ):
...
class ExternalServiceTracingMiddleware:
    ...
    @staticmethod
    def trace_external_performance(
        service: str, operation: str, duration_ms: float, success: bool = True, **kwargs
    ):
